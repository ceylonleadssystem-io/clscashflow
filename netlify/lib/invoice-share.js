...
function sanitizePublicInvoice(invoice, profile) {
  ...
  return {
    ...
    businessAddress: text(Object.prototype.hasOwnProperty.call(settings, 'addr') ? settings.addr : profile.addr, 800),
    businessEmail: text(settings.email || profile.email || profile.invEmail, 220),
    vatNumber: text(settings.vat || profile.vat, 120),
    registrationNumber: text(settings.registrationNumber || profile.registrationNumber, 120),
    bankName: text(settings.bankName || profile.bankName, 180),
    bankAccountName: text(settings.bankAccountName || profile.bankAccountName, 180),
    bankAccountNumber: text(settings.bankAccountNumber || profile.bankAccountNumber, 120),
    bankBranch: text(settings.bankBranch || profile.bankBranch, 180),
...
function sanitizePublicSnapshot(invoice) {
  ...
  return {
    ...
    registrationNumber: text(invoice.registrationNumber, 120),
    bankName: text(invoice.bankName, 180),
    bankAccountName: text(invoice.bankAccountName, 180),
    bankAccountNumber: text(invoice.bankAccountNumber, 120),
    bankBranch: text(invoice.bankBranch, 180),
