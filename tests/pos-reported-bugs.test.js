...
test('products can generate scannable and printable barcode labels', () => {
  ...
  assert.match(pos, /25 × 25 mm micro/);
  assert.match(pos, /30 × 25 mm micro/);
  assert.match(pos, /35 × 25 mm micro/);
  assert.match(pos, /35 × 35 mm compact square/);
  ...
  assert.match(pos, /margin:28,nameFont:10,descFont:0,priceFont:10/);
  assert.match(pos, /width<=35&&height<=25/);
  assert.match(pos, /margin:32,nameFont:11,descFont:0,priceFont:11/);
  ...
  assert.match(pos, /width<=35&&height<=35/);
  assert.match(pos, /barcodeH:145/);
  ...
  assert.match(pos, /drawCode39\(context,product\.code,margin,layout\.barcodeY,dotsW-margin\*2,layout\.barcodeH,layout\.darken\)/);
  assert.match(pos, /BITMAP 0,0/);
  assert.match(pos, /GAP 0 mm,0/);
  assert.match(pos, /DENSITY 15/);
  assert.match(pos, /SPEED 2/);
  assert.match(pos, /single\.length\*count/);
